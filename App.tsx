            ...
            >
                <div className="space-y-4 text-right font-sans" dir="rtl">
                    ...
                    <div className="pt-2 flex gap-3">
                        <button
                            type="button"
                            onClick={handleGrantBadgeReward}
                            className="flex-1 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-black py-3 rounded-xl transition-all shadow-lg active:scale-[0.98] flex items-center justify-center gap-2 text-sm md:text-base"
                        >
                            <span>🎖️</span>
                            <span>إضافة مكافأة الأوسمة الآن</span>
                        </button>
                        <button
                            type="button"
                            onClick={() => setBadgeRewardModalOpen(false)}
                            className="bg-indigo-800 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-xl transition-colors text-sm"
                        >
                            إلغاء
                        </button>
